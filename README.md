...
```text
local-bible-reader-offline-1.3.0-release.apk
```
...
```text
D:\bible-reader\dist\android\local-bible-reader-offline-1.3.0-release.apk
```
...
- 包含 Android 离线 APK，但不含 GitHub 资源包下载和应用内更新
- 不包含 DeepSeek / OpenAI / 小米 MiMo 云端 AI 和语音识别
- 使用独立端口和独立用户数据库
