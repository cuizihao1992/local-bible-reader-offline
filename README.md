...
```text
local-bible-reader-offline-1.22.0-release.apk
```
...
```text
D:\bible-reader\dist\android\local-bible-reader-offline-1.22.0-release.apk
```
...
- 智能查经过程可见；阅读时可并排对照译本
- 圣经智能体：长期记忆（偏好/在读/查过的主题）、近期对话、溢出摘要；查经与讲解走同一套工具循环；经文只从本机译本取
