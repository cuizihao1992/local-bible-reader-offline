...
```text
local-bible-reader-offline-1.29.0-release.apk
```
...
```text
D:\bible-reader\dist\android\local-bible-reader-offline-1.29.0-release.apk
```
...
- 智能查经过程可见；阅读时可并排对照译本
- 圣经智能体：长期记忆、对话记录、查经笔记（整理后可按笔记继续问或写到本节）；「我的 → 笔记」里经文笔记和查经笔记在一起；经文只从本机译本取
- 对话模型可切换小米 / DeepSeek / Grok / GPT / Claude / 自定义兼容接口；口令识别仍用小米
- 导入 / 导出个人数据
- 设置分「助手 / 辞典 / 系统」；「我的」分「标注 / 资源 / 更新」；底栏可直接打开助手
- 本地诊断
- Electron 桌面入口
