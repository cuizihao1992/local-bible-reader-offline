...
```text
local-bible-reader-offline-1.37.3-release.apk
```
...
```text
D:\bible-reader\dist\android\local-bible-reader-offline-1.37.3-release.apk
```
...
开发过程中你提过的需求和原话，整理在 [`docs/用户对话.md`](docs/用户对话.md)。API Key 不收录。
