...
```text
local-bible-reader-offline-1.30.0-release.apk
```
...
```text
D:\bible-reader\dist\android\local-bible-reader-offline-1.30.0-release.apk
```
...
- 智能查经过程可见；阅读时可并排对照译本
- 批注挂在经文上；查经记录来自助手整理，可编辑、继续问。支持 Markdown 导入导出。经文只从本机译本取
