...
```text
local-bible-reader-offline-1.28.0-release.apk
```
...
```text
D:\bible-reader\dist\android\local-bible-reader-offline-1.28.0-release.apk
```
...
- 智能查经过程可见；阅读时可并排对照译本
- 圣经智能体：长期记忆、对话记录、查经笔记（整理后可按笔记继续问，笔记在助手和「我的 → 查经」）；经文只从本机译本取
