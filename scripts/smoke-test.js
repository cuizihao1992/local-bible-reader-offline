...
assert(appJs.includes("function formatNoteMarkdown"), "Markdown note renderer missing");
assert(appJs.includes("600 到 1800"), "Comprehensive distill prompt missing");
...
assert(appJs.includes("function applyBuiltInMimoKeys"), "Built-in MiMo keys missing");
assert(appJs.includes("BIBLE_AI_DEFAULTS"), "AI defaults loader missing");
